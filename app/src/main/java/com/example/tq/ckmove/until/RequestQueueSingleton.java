...
public class RequestQueueSingleton {
    ...
    private static volatile RequestQueueSingleton mInstance;
    ...
    public static RequestQueueSingleton getInstance(Context context) {
        RequestQueueSingleton inst = mInstance;
        if (inst == null) {
            synchronized (RequestQueueSingleton.class) {
                inst = mInstance;
                if (inst == null) {
                    inst = new RequestQueueSingleton(context.getApplicationContext());
                    mInstance = inst;
                }
            }
        }
            ...
            call.enqueue(new Callback() {
                ...
                public void onResponse(Call call, Response response) throws IOException {
                    if (response.isSuccessful()) {
                        ...
                        String string = new String(b, "GB2312"); //然后将其转为gb2312
